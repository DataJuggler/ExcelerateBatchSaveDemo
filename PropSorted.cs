...
namespace DataFields
{
    ...
    #region class PropSorted
    public class PropSorted
    {
        ...
        #region Methods
            ...
            #region Load(Row row)
            /// <summary>
            /// This method loads a PropSorted object from a Row.
            /// </Summary>
            ...
            /// <summary>
            /// This method loads a list of PropSorted objects from a Worksheet.
            /// </Summary>
            /// <param name="worksheet">The worksheet which the rows collection will be used to load a list of PropSorted objects.</param>
            public static List<PropSorted> Load(Worksheet worksheet)
            {
                // Initial value
                List<PropSorted> propSortedList = new List<PropSorted>();
                ...
                if ((NullHelper.Exists(worksheet)) && (worksheet.HasRows))
                {
                    ...
                    foreach (Row row in worksheet.Rows)
                    {
                        ...
                        {
                            // Create a new instance of a PropSorted object.
            ...
            /// <summary>
            /// This method creates the columns for the row to save a new PropSorted object.
            /// </Summary>
            ...
            #region Save(Row row)
            /// <summary>
            /// This method saves a PropSorted object back to a Row.
            /// </Summary>
